					 	...
					 	<div class="jumbotron">
					 		...
					 		<h1 class="text-center">¡Hola!</h1> 
					 		 ...
					 		 <p class="text-center">
								...
								Tu artículo ha sido asignado a tus compras, pero antes queremos presentarte las siguientes ofertas, si no deseas ver las ofertas y quieres continuar en el artículo que acabas de adquirir haz click en el siguiente botón:
								<br><br>
								<a href="'.$url.'perfil">
